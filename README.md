...
- use `addArrayArrayString()` to merge more strings into an existing property/key entry without replacing its current values; a missing entry is initialized automatically
